...
<template>
	<view class="uni-content">
		<!-- <uni-icons class="icon" type="back" size="30"></uni-icons> -->
		<u-icon @click="sjou" name="arrow-left" size="50" top="100"></u-icon>
		<image class="img" src="/static/img/deng.svg" mode=""></image>
		<!-- 顶部文字 -->
		<!-- <image src="/static/img/deng.svg" mode=""></image> -->
		<text class="title title-box">欢迎登陆</text>
